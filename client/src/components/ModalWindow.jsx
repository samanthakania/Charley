...
class ModalWindow extends Component {
  ...
  fetchWeather() {
    fetch(
      proxyURL +
        `https://api.darksky.net/forecast/379b67815f86fa3fb81b23bff3f6db3a/${
          this.props.park.lat
  ...
  render() {
    ...
    return (
      <div>
        <button className="btn btn-warning" onClick={this.handleOpenModal}>
        ...
        >
          <Tabs>
            ...
            <TabPanel>
              <WeatherTab weather={this.state.weather} park={this.props.park} />
            </TabPanel>
            <TabPanel>
              <ParkAdvisoriesTab
