...
class MyMapComponent extends Component {
  ...
  componentDidMount() {
    ...
    this.map = this.mapElt.current.context[
    ...
    this.directionsService.route(
      ...
      function(response, status) {
        if (status === "OK") {
          ...
          window.alert(
            "Oh no! It looks like our map cannot generate a route to this park. Please choose another."
          );
  ...
  addWaypoint = waypoint => {
    ...
    this.setState({ waypoints: waypoints, modal: false }, () => {
      this.route();
    });
  };
